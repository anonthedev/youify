export default function page() {
  return (
    <main className="w-screen bg-white flex items-center justify-center">
      <section className="prose prose-stone">
        <p>Google Project Number: 79450447307</p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Youify.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Youify, accessible from
              <a
                href="youify.xyz"
        ...
        <p>
          We use YouTube API to create a playlist in your account and then add
          some videos to that playlist. You will be able to see which videos we
          are going to add to the playlist.
        </p>
        ...
        <p>
          <strong>This application uses YouTube API.</strong>
        </p>

        <p>
          By using this application you are also being bound to YouTube terms of
          services <a href="https://www.youtube.com/t/terms">Youtube TOS</a>
        </p>
        ...
        <p>
          <strong>Reference to Google Privacy Policy - </strong>
        ...
        <ul>
          <li>
            <p>
              <strong> We use YouTube API</strong> to create a playlist in your
              account and then add some videos to that playlist. You will be
              able to see which videos we are going to add to the playlist.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          <strong>You can revoke permission for this application</strong>
          <a
        ...
        <ul>
          <li>
            ...
            <a
              ...
              data-cfemail="f38796909b849a97dd8381929d9285b3949e929a9fdd909c9e"
            >
              [email&#160;protected]
            </a>
          </li>
